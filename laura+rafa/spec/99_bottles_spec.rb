...
Take one down and pass it around, 98 bottles of beer on the wall."
  ...
  it 'prints a verse for 98 bottles correctly' do
    expected = "98 bottles of beer on the wall, 98 bottles of beer.
Take one down and pass it around, 97 bottles of beer on the wall."
    expect(BeerSong.new.verse(98)).to eq(expected)
  end

  it 'prints the verse before the last' do
    expected = "1 bottle of beer on the wall, 1 bottle of beer.
Take it down and pass it around, no more bottles of beer on the wall."
    expect(BeerSong.new.verse(1)).to eq(expected)
  end

  it 'prints last verse' do
...
class BeerSong
  def verses(initial_bottle, end_bottle)
    (end_bottle..initial_bottle).to_a.reverse.map do |current_bottle|
      verse(current_bottle)
    end.join("\n\n")
  end
